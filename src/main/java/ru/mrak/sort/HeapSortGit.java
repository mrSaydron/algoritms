...
public class HeapSortGit implements Sort {
/**
* Heap Sort Algorithm
* Implements MinHeap
* 
...
*/
	...
	public final int[] sort(int[] arr, boolean increace)  {
	  this.setHeap(arr);
...
*/
	public static void main(String[] args) {
		//int[] heap = getInput();
		//HeapSortGit data = new HeapSortGit(heap);
